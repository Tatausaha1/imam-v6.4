...
import { BookOpenIcon, PlusIcon, CalendarIcon, UserIcon, ClockIcon, BuildingLibraryIcon } from './Ikon';
...
const JurnalMengajar: React.FC<JurnalMengajarProps> = ({ onBack, userRole }) => {

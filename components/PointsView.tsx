    ...
    const init = async () => {
        ...
        if (isMockMode) {
            setTimeout(() => {
                ...
                setRules([
                    { id: 'R1', category: 'Kedisiplinan', description: 'Atribut seragam tidak lengkap', points: 5 },
                    ...
                    { id: 'R4', category: 'Kedisiplinan', description: 'Keluar kelas tanpa izin', points: 10 },
                ]);
                setLogs([
                    { id: '1', studentId: 's1', studentName: 'Ahmad Dahlan', type: 'Violation', ruleId: 'R1', ruleDescription: 'Atribut Tidak Lengkap', points: -5, date: '2024-05-20', recordedBy: 'Admin', status: 'Approved' }
                ]);
                setStudents([
